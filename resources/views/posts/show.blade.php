                ...
                <section class='col-span-8 col-start-4 mt-10 space-y-5'>
                    @auth
                        <form action="/posts/{{ $post->title }}/comments" method="post"
                            ...
                            <div class="mt-7">
                                <textarea name="body" rows="5" class="w-full focus:outline-none text-sm" placeholder="Write a comment"
                            ...
                            <div class="flex justify-end border-t border-gray-200 pt-4">
                                <button type="submit"
                                    class="bg-blue-500 hover:bg-blue-600 text-white py-3 px-8 rounded-3xl uppercase text-xs font-semibold">
                                    Comment
                                </button>
                            </div>
                        </form>
